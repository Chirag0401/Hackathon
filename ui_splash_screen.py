...
"}")
        ...
        self.label_credits.setAlignment(Qt.AlignHCenter|Qt.AlignTrailing|Qt.AlignVCenter)
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>Mudra</strong>", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Created</strong>: By Team Fronick", None))
    # retranslateUi
